...
function TwoWayFlightSearchDetails() {
  ...
  const[firstFare,setFirstFare]=useState(0)
  const[secondFare,setSecondFare]=useState(0)
  const[totalFare,setTotalFare]=useState(0)

  const handleRadioChange=(e)=>{
    var index=e.target.value
    const arr=flightData.filter(data=>data.resultIndex==index)
    var fare=arr[0].publishedFare
    setFirstFare(fare)
    setTotalFare(fare+secondFare)
        ...
        <div class="round-trip-fare fixed-bottom bg-dark shadow-md text-light">
          <div class="container p-2 p-sm-4">
            <div class="row align-items-center">
              ...
              <div class="col-3">
                <div class="row align-items-center">
                  <div class="col-12 col-md-6 text-light text-center text-6 price"><span class="text-1 text-white-50 d-none d-lg-block">Total Fare: </span>₹{totalFare+markup}</div>
...
export default TwoWayFlightSearchDetails
